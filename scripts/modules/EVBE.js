    ...
    appendSmiles: function(editmode) {
        ...
        $(smiles).each(function() {
            if (!editmode) {
                ...
                $('#EVBE_Smileys').append('<div style="display: inline-block;"><div style="position: relative; z-index: 1; left: 1px; top: 12px; color: red; cursor: pointer;" onclick="EVBE.deleteSmile(\'' + this[0] + '\', \'' + this[1] + '\');"><i class="fa fa-ban"></i></div><img src="' + this[1] + '" title="' + this[0] + '" height="32px" width="32px" style="padding-right: 10px;"></div>');
            }
        });
        return;
    },
